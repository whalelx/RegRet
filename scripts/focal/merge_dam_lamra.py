...
lamra_model = "../LamRA/checkpoints/LamRA-repli-Pretrained"
vision_backbone = "./checkpoints/qwen2-vl-7b_DAM_stage1"
...
processor = AutoProcessor.from_pretrained("../LamRA/checkpoints/LamRA-repli-Pretrained")
processor.save_pretrained(save_dir)  # 这一句会把preprocessor_config.json、chat_template.json等复制过来
tokenizer = AutoTokenizer.from_pretrained("../LamRA/checkpoints/LamRA-repli-Pretrained")
