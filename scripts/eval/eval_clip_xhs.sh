...
# python -m ipdb eval/eval_clip.py \
CUDA_VISIBLE_DEVICES='0,1,2' accelerate launch --multi_gpu --main_process_port 29509 eval/eval_clip.py \
...
CUDA_VISIBLE_DEVICES='3,4,5' accelerate launch --multi_gpu --main_process_port 29530 eval/eval_clip.py \
...
# CUDA_VISIBLE_DEVICES='3,4,5,6' accelerate launch --multi_gpu --main_process_port 29530 eval/eval_clip.py \
