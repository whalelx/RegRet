...
MODEL_ID="checkpoints/qwen2_5-vl-7b_Higher_tune"
# MODEL_ID="checkpoints/qwen2_5-vl-7b_debug"
# MODEL_ID="checkpoints/qwen2_5-vl-7b_LEMUIR_tune_genloss0.3_mbeirlanguage"
# MODEL_ID=checkpoints/qwen2_5-vl-7b_MetaQuery_tune_2nodes
# MODEL_ID=checkpoints/qwen2_5-vl-7b_MetaQuery_tune
