...
CUDA_VISIBLE_DEVICES='1' accelerate launch --multi_gpu --main_process_port 29509 eval/eval_vlm2vec.py \
...
# CUDA_VISIBLE_DEVICES='0' accelerate launch --multi_gpu --main_process_port 29530 eval/eval_vlm2vec.py \
