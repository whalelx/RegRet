...
DATASET_ID_XHS = "10"
TASK_ID_XHS = "7"
IMAGE_PATH_PREFIX_MBEIR = "/mnt/tidal-alsh01/dataset/mmeb/M-BEIR/mbeir_images"
XHS_IMAGE_SUBDIR = "xhs_images" # Assumed subdirectory for XHS images within IMAGE_PATH_PREFIX_MBEIR
    ...
    for original_query_id, candidate_items_for_query in tqdm(queries_input.items()):
        ...
        for i, original_score_key_for_item in enumerate(sorted_original_score_keys_for_current_query_candidates):
            ...
            if original_cand_identifier not in global_orig_cand_to_mbeir_did:
                ...
                if original_cand_img_path:
                    cand_img_path_for_pool = os.path.join(IMAGE_PATH_PREFIX_MBEIR, XHS_IMAGE_SUBDIR, os.path.basename(original_cand_img_path))
        ...
        query_img_path_for_jsonl = os.path.join(IMAGE_PATH_PREFIX_MBEIR, XHS_IMAGE_SUBDIR, query_img_filename)
