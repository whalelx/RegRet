...
def get_template_and_fix_tokenizer(tokenizer: "PreTrainedTokenizer", data_args: "DataArguments") -> "Template":
    ...
    """
    if data_args.template in ["llava", "paligemma", "qwen2_vl", "qwen2_vl_vpt"]:
...
system  = "You are a helpful spatial reasoning assistant, good at analyzing fine-grained image features." + \
