...
AutoModelForCausalLM.register(VPT_Qwen2VLConfig, VPT_Qwen2VLForConditionalGeneration)
# AutoModelForConditionalGeneration.register(VPT_Qwen2VLConfig, VPT_Qwen2VLForConditionalGeneration)
print("[IMPORTANT] Register VPT_Qwen2VLConfig, VPT_Qwen2VLForConditionalGeneration, VPT_Qwen2VLProcessor!")


if __name__ == "__main__":
    from transformers import AutoModel, AutoModelForCausalLM, AutoTokenizer, AutoConfig
    AutoConfig.from_pretrained("rp-yu/Qwen2-VL-7b-VPT-CLIP", trust_remote_code=True)
    model = AutoModelForCausalLM.from_pretrained("rp-yu/Qwen2-VL-7b-VPT-CLIP")
