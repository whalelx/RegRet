...
def eval(args):
    ...
    query_dataloader = DataLoader(query_dataset, batch_size=80, num_workers=16, shuffle=False, collate_fn=query_data_collator)
    candidate_dataloader = DataLoader(cand_dataset, batch_size=80, num_workers=16, shuffle=False, collate_fn=cand_data_collator)
