...
def eval(args):
    ...
    query_dataloader = DataLoader(query_dataset, batch_size=20, num_workers=4, shuffle=False, collate_fn=query_data_collator)
    candidate_dataloader = DataLoader(cand_dataset, batch_size=20, num_workers=4, shuffle=False, collate_fn=cand_data_collator)
