...
image_output_dir = '/mnt/tidal-alsh01/usr/liangxun/data/dataset-spatial-reasoning/TreeBench/image'
output_json_path = './treebench.json'
...
with open("/mnt/tidal-alsh01/usr/liangxun/data/dataset-spatial-reasoning/TreeBench/TreeBench.tsv", 'r', encoding='utf-8') as file:
...
for d in ds:
    index, image, question, ans, choices = d[0],d[1],d[2],d[3],d[4]
