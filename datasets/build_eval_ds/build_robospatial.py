...
name = 'configuration'
# name = 'compatibility'
image_output_dir = '/mnt/tidal-alsh01/usr/liangxun/data/robospatial-home/images'
dataset_path = f'/mnt/tidal-alsh01/usr/liangxun/data/robospatial-home/data/{name}-00000-of-00001.parquet'
output_json_path = f'./robospatial-{name}.json'
