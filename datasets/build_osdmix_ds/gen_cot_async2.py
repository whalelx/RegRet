...
def bulk_evaluate(data, batch_size):
    ...
    for start in tqdm(range(0, int(len(data)*0.6), batch_size)):
        ...
        outfile = "./mix-vpt-spatial-cot.json"
...
if __name__ == "__main__":
    with open("/mnt/tidal-alsh01/usr/liangxun/STAUG/LLaMA-Factory/data/mix-vpt-spatial.json","r") as f:
        data = json.load(f)
